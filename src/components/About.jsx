...
const info = [
  ...
  { icon: GraduationCap,  label: 'Education', value: 'Incoming BS Info Tech',      color: 'text-pink-400'   },
  { icon: Code,           label: 'Focus',     value: 'Full Stack Development',     color: 'text-purple-400' },
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-purple-500/20">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="rounded-xl p-3 flex items-center gap-3"
                    style={{ background: 'rgba(19,19,31,0.85)', backdropFilter: 'blur(12px)', border: '1px solid rgba(168,85,247,0.2)' }}>
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }}
            ...
            <div className="space-y-4 text-gray-400 leading-relaxed mb-8">
              <p>Hi, I'm <strong className="text-white">Andrei Nyl Manliclic</strong>, an aspiring full-stack developer
              ...
              <p>My journey started with curiosity about how websites work, which led me to fall in love with HTML, CSS,
                JavaScript, and Node.js. I also enjoy designing intuitive UIs that blend aesthetics with functionality.</p>
              <p>As a hearing-impaired developer, I've built strong patience, focus, and attention to detail — skills
                that make me a better programmer every day.</p>
            </div>
